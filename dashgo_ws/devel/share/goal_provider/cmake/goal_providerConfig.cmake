...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'goal_provider' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aurotb/Desktop/EAIBotSmartFactory/dashgo_ws/src/navigation/goal_provider/${idir}'.  ${_report}")
    endif()
